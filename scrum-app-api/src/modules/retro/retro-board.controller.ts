...
import { RetroBoardResponseDto, MessageResponseDto } from './dto/response.dto';
...
export class RetroBoardController {
  ...
  @ApiResponse({ status: 201, description: 'Board criado com sucesso.', type: RetroBoardResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Lista de boards retornada com sucesso.', type: [RetroBoardResponseDto] })
  @ApiResponse({ status: 401, description: 'Não autorizado.' })
  async findAll() {
  ...
  @ApiResponse({ status: 200, description: 'Lista de boards do usuário retornada com sucesso.', type: [RetroBoardResponseDto] })
  @ApiResponse({ status: 401, description: 'Não autorizado.' })
  ...
  @ApiResponse({ status: 200, description: 'Board encontrado com sucesso.', type: RetroBoardResponseDto })
  ...
  @ApiParam({ name: 'id', description: 'ID do board' })
  @ApiResponse({ status: 200, description: 'Board atualizado com sucesso.', type: RetroBoardResponseDto })
  @ApiResponse({ status: 400, description: 'Dados inválidos.' })
  @ApiResponse({ status: 403, description: 'Acesso negado. Apenas o criador pode editar.' })
  @ApiResponse({ status: 404, description: 'Board não encontrado.' })
  @ApiResponse({ status: 401, description: 'Não autorizado.' })
  async update(
    @Param('id') id: string,
  ...
  @ApiParam({ name: 'id', description: 'ID do board' })
  @ApiResponse({ status: 200, description: 'Board deletado com sucesso.', type: MessageResponseDto })
  @ApiResponse({ status: 403, description: 'Acesso negado. Apenas o criador pode deletar.' })
  @ApiResponse({ status: 404, description: 'Board não encontrado.' })
  @ApiResponse({ status: 401, description: 'Não autorizado.' })
  async delete(
    @Param('id') id: string,
  ...
  @ApiParam({ name: 'id', description: 'ID do board' })
  @ApiResponse({ status: 200, description: 'Board arquivado com sucesso.', type: RetroBoardResponseDto })
  @ApiResponse({ status: 403, description: 'Acesso negado. Apenas o criador pode arquivar.' })
  @ApiResponse({ status: 404, description: 'Board não encontrado.' })
  @ApiResponse({ status: 401, description: 'Não autorizado.' })
  async archive(
    @Param('id') id: string,
